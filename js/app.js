var QUESTIONS = { // feel free to suggest improvements
  "Computer Science": {
    "Data Structures": [
    ...
    "Algorithms": [
      ...
      "Tree, Graph, simple greedy and divide and conquer algorithms, big O notation",
  ...
  "Knowledge": {
    "Tool Knowledge": [
      "Limited to primary IDE (Eclipse etc.)",
      "Knows about some alternatives to popular and standard tools",
      "Good knowledge of editors, debuggers, IDEs, open source alternatives etc.",
...
$(function() {
    ...
    new app.AppView();
    console.debug("Kicking off (" + app.Items.length + " items in localStorage)");
    ...
    if (app.Items.length) {
      go();
        ...
        $("#go").click(function() {
            ...
            _.each(QUESTIONS, function(items, topic) {
                _.each(items, function(levels, item) {
                    app.Items.create({
                        title: item,
                        topic: topic,
                        levels: levels
